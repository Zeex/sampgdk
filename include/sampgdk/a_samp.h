...
SAMPGDK_CALLBACK(bool, OnPlayerConnect(int playerid)); /* $badRet=0 */
SAMPGDK_CALLBACK(bool, OnPlayerDisconnect(int playerid, int reason)); /* $badRet=0 */
SAMPGDK_CALLBACK(bool, OnPlayerSpawn(int playerid)); /* $badRet=0 */
...
SAMPGDK_CALLBACK(bool, OnPlayerCommandText(int playerid, const char *cmdtext)); /* $badRet=1 */
SAMPGDK_CALLBACK(bool, OnPlayerRequestClass(int playerid, int classid)); /* $badRet=0 */
...
SAMPGDK_CALLBACK(bool, OnPlayerEnterCheckpoint(int playerid)); /* $badRet=0 */
SAMPGDK_CALLBACK(bool, OnPlayerLeaveCheckpoint(int playerid));
SAMPGDK_CALLBACK(bool, OnPlayerEnterRaceCheckpoint(int playerid)); /* $badRet=0 */
SAMPGDK_CALLBACK(bool, OnPlayerLeaveRaceCheckpoint(int playerid));
SAMPGDK_CALLBACK(bool, OnRconCommand(const char *cmd)); /* $badRet=1 */
SAMPGDK_CALLBACK(bool, OnPlayerRequestSpawn(int playerid)); /* $badRet=0 */
...
SAMPGDK_CALLBACK(bool, OnVehicleMod(int playerid, int vehicleid, int componentid)); /* $badRet=0 */
...
SAMPGDK_CALLBACK(bool, OnPlayerKeyStateChange(int playerid, int newkeys, int oldkeys)); /* $badRet=0 */
SAMPGDK_CALLBACK(bool, OnRconLoginAttempt(const char *ip, const char *password, bool success));
SAMPGDK_CALLBACK(bool, OnPlayerUpdate(int playerid)); /* $badRet=0 */
...
SAMPGDK_CALLBACK(bool, OnDialogResponse(int playerid, int dialogid, int response, int listitem, const char *inputtext)); /* $badRet=1 */
