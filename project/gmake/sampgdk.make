...
ifeq ($(config),debugdll32)
  OBJDIR     = ../../obj/Debug/x32/DebugDLL
  TARGETDIR  = ../../bin/Debug
  TARGET     = $(TARGETDIR)/sampgdkDG.dll
  DEFINES   += -DIN_SAMPGDK
  INCLUDES  += -I../../include -I../../include/sampgdk/amx
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -Wall -g -m32
...
ifeq ($(config),releasedll32)
  OBJDIR     = ../../obj/Release/x32/ReleaseDLL
  TARGETDIR  = ../../bin/Release
  TARGET     = $(TARGETDIR)/sampgdkG.dll
  DEFINES   += -DIN_SAMPGDK
  INCLUDES  += -I../../include -I../../include/sampgdk/amx
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -m32
