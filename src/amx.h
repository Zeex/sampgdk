...
extern void **sampgdk_amx_exports;

static uint16_t *AMXAPI amx_Align16(uint16_t *v) {
  typedef uint16_t *(AMXAPI *amx_Align16_t)(uint16_t *v);
  amx_Align16_t fn = sampgdk_amx_exports[PLUGIN_AMX_EXPORT_Align16];
  return fn(v);
}

static uint32_t *AMXAPI amx_Align32(uint32_t *v) {
...
static uint64_t *AMXAPI amx_Align64(uint64_t *v) {
...
static int AMXAPI amx_Allot(AMX *amx, int cells, cell *amx_addr,
                            cell **phys_addr) {
...
static int AMXAPI amx_Callback(AMX *amx, cell index, cell *result,
                               cell *params) {
...
static int AMXAPI amx_Clone(AMX *amxClone, AMX *amxSource, void *data) {
...
static int AMXAPI amx_FindNative(AMX *amx, const char *name, int *index) {
...
static int AMXAPI amx_FindPublic(AMX *amx, const char *funcname, int *index) {
...
static int AMXAPI amx_FindPubVar(AMX *amx, const char *varname,
                                 cell *amx_addr) {
...
static int AMXAPI amx_FindTagId(AMX *amx, cell tag_id, char *tagname) {
...
static int AMXAPI amx_Flags(AMX *amx, uint16_t *flags) {
  typedef int (AMXAPI *amx_Flags_t)(AMX *amx, uint16_t *flags);
  amx_Flags_t fn = sampgdk_amx_exports[PLUGIN_AMX_EXPORT_Flags];
  return fn(amx, flags);
}

static int AMXAPI amx_GetAddr(AMX *amx, cell amx_addr, cell **phys_addr) {
...
static int AMXAPI amx_GetNative(AMX *amx, int index, char *funcname) {
...
static int AMXAPI amx_GetPublic(AMX *amx, int index, char *funcname) {
...
static int AMXAPI amx_GetPubVar(AMX *amx, int index, char *varname,
                                cell *amx_addr) {
...
static int AMXAPI amx_GetString(char *dest, const cell *source, int use_wchar,
                                size_t size) {
...
static int AMXAPI amx_GetTag(AMX *amx, int index, char *tagname, cell *tag_id) {
...
static int AMXAPI amx_GetUserData(AMX *amx, long tag, void **ptr) {
...
static int AMXAPI amx_Init(AMX *amx, void *program) {
...
static int AMXAPI amx_InitJIT(AMX *amx, void *reloc_table, void *native_code) {
...
static int AMXAPI amx_MemInfo(AMX *amx, long *codesize, long *datasize,
                              long *stackheap) {
...
static int AMXAPI amx_NameLength(AMX *amx, int *length) {
...
static AMX_NATIVE_INFO *AMXAPI amx_NativeInfo(const char *name,
                                              AMX_NATIVE func) {
...
static int AMXAPI amx_NumNatives(AMX *amx, int *number) {
...
static int AMXAPI amx_NumPublics(AMX *amx, int *number) {
...
static int AMXAPI amx_NumPubVars(AMX *amx, int *number) {
...
static int AMXAPI amx_PushString(AMX *amx, cell *amx_addr, cell **phys_addr,
...
static int AMXAPI amx_RaiseError(AMX *amx, int error) {
...
static int AMXAPI amx_Register(AMX *amx, const AMX_NATIVE_INFO *nativelist,
                               int number) {
...
static int AMXAPI amx_Release(AMX *amx, cell amx_addr) {
...
static int AMXAPI amx_SetCallback(AMX *amx, AMX_CALLBACK callback) {
...
static int AMXAPI amx_SetDebugHook(AMX *amx, AMX_DEBUG debug) {
...
static int AMXAPI amx_SetString(cell *dest, const char *source, int pack,
                                int use_wchar, size_t size) {
...
static int AMXAPI amx_SetUserData(AMX *amx, long tag, void *ptr) {
...
static int AMXAPI amx_StrLen(const cell *cstring, int *length) {
...
static int AMXAPI amx_UTF8Check(const char *string, int *length) {
...
static int AMXAPI amx_UTF8Get(const char *string, const char **endptr,
                              cell *value) {
...
static int AMXAPI amx_UTF8Len(const cell *cstr, int *length) {
...
static int AMXAPI amx_UTF8Put(char *string, char **endptr, int maxchars,
                              cell value) {
