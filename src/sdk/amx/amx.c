...
uint16_t *AMXAPI amx_Align16(uint16_t *v) {
  ...
  amx_Align16_t fn = amx_exports[PLUGIN_AMX_EXPORT_Align16];
  return fn(v);
}

uint32_t *AMXAPI amx_Align32(uint32_t *v) {
  typedef uint32_t *(AMXAPI *amx_Align32_t)(uint32_t *v);
  amx_Align32_t fn = amx_exports[PLUGIN_AMX_EXPORT_Align32];
  return fn(v);
}
...
uint64_t *AMXAPI amx_Align64(uint64_t *v) {
  ...
  amx_Align64_t fn = amx_exports[PLUGIN_AMX_EXPORT_Align64];
  return fn(v);
}
...
int AMXAPI amx_Allot(AMX *amx, int cells, cell *amx_addr, cell **phys_addr) {
  typedef int (AMXAPI *amx_Allot_t)(AMX *amx, int cells, cell *amx_addr,
                                    cell **phys_addr);
  amx_Allot_t fn = amx_exports[PLUGIN_AMX_EXPORT_Allot];
...
int AMXAPI amx_FindNative(AMX *amx, const char *name, int *index) {
  typedef int (AMXAPI *amx_FindNative_t)(AMX *amx, const char *name,
                                         int *index);
  amx_FindNative_t fn = amx_exports[PLUGIN_AMX_EXPORT_FindNative];
...
int AMXAPI amx_FindPublic(AMX *amx, const char *funcname, int *index) {
  typedef int (AMXAPI *amx_FindPublic_t)(AMX *amx, const char *funcname,
                                         int *index);
  amx_FindPublic_t fn = amx_exports[PLUGIN_AMX_EXPORT_FindPublic];
...
int AMXAPI amx_GetPubVar(AMX *amx, int index, char *varname, cell *amx_addr) {
  typedef int (AMXAPI *amx_GetPubVar_t)(AMX *amx, int index, char *varname,
                                        cell *amx_addr);
  amx_GetPubVar_t fn = amx_exports[PLUGIN_AMX_EXPORT_GetPubVar];
...
int AMXAPI amx_GetString(char *dest, const cell *source, int use_wchar,
  ...
  amx_GetString_t fn = amx_exports[PLUGIN_AMX_EXPORT_GetString];
...
int AMXAPI amx_InitJIT(AMX *amx, void *reloc_table, void *native_code) {
  typedef int (AMXAPI *amx_InitJIT_t)(AMX *amx, void *reloc_table,
                                      void *native_code);
  amx_InitJIT_t fn = amx_exports[PLUGIN_AMX_EXPORT_InitJIT];
...
int AMXAPI amx_MemInfo(AMX *amx, long *codesize, long *datasize,
  ...
  amx_MemInfo_t fn = amx_exports[PLUGIN_AMX_EXPORT_MemInfo];
  return fn(amx, codesize, datasize, stackheap);
}

int AMXAPI amx_NameLength(AMX *amx, int *length) {
  typedef int (AMXAPI *amx_NameLength_t)(AMX *amx, int *length);
  amx_NameLength_t fn = amx_exports[PLUGIN_AMX_EXPORT_NameLength];
...
AMX_NATIVE_INFO *AMXAPI amx_NativeInfo(const char *name, AMX_NATIVE func) {
  typedef AMX_NATIVE_INFO *(AMXAPI *amx_NativeInfo_t)(const char *name,
                                                       AMX_NATIVE func);
  amx_NativeInfo_t fn = amx_exports[PLUGIN_AMX_EXPORT_NativeInfo];
  return fn(name, func);
}

int AMXAPI amx_NumNatives(AMX *amx, int *number) {
  typedef int (AMXAPI *amx_NumNatives_t)(AMX *amx, int *number);
  amx_NumNatives_t fn = amx_exports[PLUGIN_AMX_EXPORT_NumNatives];
  return fn(amx, number);
}

int AMXAPI amx_NumPublics(AMX *amx, int *number) {
  typedef int (AMXAPI *amx_NumPublics_t)(AMX *amx, int *number);
  amx_NumPublics_t fn = amx_exports[PLUGIN_AMX_EXPORT_NumPublics];
  return fn(amx, number);
}

int AMXAPI amx_NumPubVars(AMX *amx, int *number) {
  typedef int (AMXAPI *amx_NumPubVars_t)(AMX *amx, int *number);
  amx_NumPubVars_t fn = amx_exports[PLUGIN_AMX_EXPORT_NumPubVars];
  return fn(amx, number);
}

int AMXAPI amx_NumTags(AMX *amx, int *number) {
  typedef int (AMXAPI *amx_NumTags_t)(AMX *amx, int *number);
  amx_NumTags_t fn = amx_exports[PLUGIN_AMX_EXPORT_NumTags];
  return fn(amx, number);
}

int AMXAPI amx_Push(AMX *amx, cell value) {
  typedef int (AMXAPI *amx_Push_t)(AMX *amx, cell value);
  amx_Push_t fn = amx_exports[PLUGIN_AMX_EXPORT_Push];
  return fn(amx, value);
}
...
int AMXAPI amx_PushArray(AMX *amx, cell *amx_addr, cell **phys_addr,
  ...
  typedef int (AMXAPI *amx_PushArray_t)(AMX *amx, cell *amx_addr,
                                        ...
                                        int numcells);
  amx_PushArray_t fn = amx_exports[PLUGIN_AMX_EXPORT_PushArray];
...
int AMXAPI amx_PushString(AMX *amx, cell *amx_addr, cell **phys_addr,
  ...
  amx_PushString_t fn = amx_exports[PLUGIN_AMX_EXPORT_PushString];
  return fn(amx, amx_addr, phys_addr, string, pack, use_wchar);
}

int AMXAPI amx_RaiseError(AMX *amx, int error) {
  typedef int (AMXAPI *amx_RaiseError_t)(AMX *amx, int error);
  amx_RaiseError_t fn = amx_exports[PLUGIN_AMX_EXPORT_RaiseError];
  return fn(amx, error);
}
...
int AMXAPI amx_UTF8Get(const char *string, const char **endptr, cell *value) {
  typedef int (AMXAPI *amx_UTF8Get_t)(const char *string, const char **endptr,
                                      cell *value);
  amx_UTF8Get_t fn = amx_exports[PLUGIN_AMX_EXPORT_UTF8Get];
  return fn(string, endptr, value);
}

int AMXAPI amx_UTF8Len(const cell *cstr, int *length) {
  typedef int (AMXAPI *amx_UTF8Len_t)(const cell *cstr, int *length);
  amx_UTF8Len_t fn = amx_exports[PLUGIN_AMX_EXPORT_UTF8Len];
...
int AMXAPI amx_UTF8Put(char *string, char **endptr, int maxchars, cell value) {
  ...
  amx_UTF8Put_t fn = amx_exports[PLUGIN_AMX_EXPORT_UTF8Put];
